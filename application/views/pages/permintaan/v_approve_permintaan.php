                ...
                foreach ($list->result() as $data) {
                    ...
                    <tr>
                        ...
                        <?php if(($level=="MANAGER MTN") OR ($level=="TEKNISI")){ ?>
                            <td valign="top">
                                <?php if($level=="TEKNISI"){ ?>
                                    <?php echo $data->keterangan_mtn ?>
                                <?php } else { ?>
                                    <textarea name="keterangan_mtn[]" id="keterangan_mtn_<?php echo $no ?>" maxlength="100" style="resize:none;width : 250px; height : 40px;"><?php echo $data->keterangan_mtn ?></textarea>
                                <?php } ?>
                        ...
                        <td valign="top">
                            <img onclick="view_gambar(this)" id="foto_gambar_<?php echo $no ?>" src="<?php echo base_url()?>assets/img/permintaan/<?php echo $data->gambar ?>" alt="" style="width: 20%; height:20%;" onerror="this.onerror=null;this.src=\''+<?php echo base_url('assets/img/not_found.png')?>'\';"/>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
...
<script>
    ...
    // function simpan_data(){
        ...
        if(level=="TEKNISI"){
            url_set = '<?php echo base_url('c_permintaan_new/approve_data_progres') ?>'
        } else{
            url_set = '<?php echo base_url('c_permintaan_new/approve_data_proses') ?>'
        }
        $.ajax({
            url        : url_set,
            type       : "POST",
