<script>
    var Url = '<?php echo base_url();?>';                
        ...
        methods: {
            ...
            getdata: function() {
                axios.get(Url+'c_departemen/data_departemen').then(
                    result => {
                        this.data_departemen = result.data
            ...
            hapus_data: function(id_departemen) {
                var conf = confirm("data akan dihapus?");
                if(!conf) return true;
                var vm = this;
                axios.get(Url+'c_departemen/delete_data/'+id_departemen).then(function(response) {     
