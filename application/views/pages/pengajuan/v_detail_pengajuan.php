        ...
        <div id="printarea">
            ...
            <table class="customers_a">
                <tr>
                    ...
                    <td><?php echo $head->tgl_pengajuan ?></td>
                </tr>
                <tr>
                    <td>Departemen</td>
                    <td>:</td>
                ...
                <tbody id="row_body">
                    ...
                    foreach ($list->result() as $data) {
                        ...
                        <tr>
                            ...
                            <td valign="top"><?php echo $data->tgl_approve_mtn ?></td>
                            <td valign="top"><?php echo $data->app_mnger ?></td>
                            <td valign="top"><?php echo $data->tgl_approve_manager ?></td>
                            ...
                            <td valign="top"><?php echo $data->tgl_perbaikan ?></td>
                            <td valign="top"><?php echo $data->tgl_selesai ?></td>
                            <td valign="top">
